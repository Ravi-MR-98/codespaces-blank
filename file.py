        ...
        for shift_index, (start_hour, end_hour) in enumerate(SHIFT_TIMES):
            ...
            for _ in range(workers_needed):
                ...
                for employee in employees:
                    if date_str not in employee_availability.get(employee, []) and (current_shift[employee] == shift_index or current_shift[employee] == -1) and shift_index in employee_shift_preference.get(employee, [0, 1, 2]) and weekly_hours[employee] + HOURS_PER_SHIFT <= max_hours_per_week:
